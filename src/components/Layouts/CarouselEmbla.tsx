...
import photo1 from "~/assets/images/portfolio/1_7PV_1_Full.jpg";
...
const data = [
  ...
  {
    key: 2,
    src: "src/assets/images/portfolio/1_7PV_2_Drive_Stress.jpg",
  },
  {
    key: 3,
  ...
  {
    key: 11,
    src: "src/assets/images/portfolio/3_Tilt_2_manifold_connections.jpg",
  },
  {
    key: 12,
...
export function SlideComponent() {
  return <Carousel.Slide></Carousel.Slide>;
}
